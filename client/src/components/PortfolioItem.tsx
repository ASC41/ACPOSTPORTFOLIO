...
export default function PortfolioItem({
  ...
  const renderHeroVideo = () => {
    ...
    if (id === "syfy-magicians") {
      if (isMobile) {
        return (
          <>
            {/* Background layer - cropped to fill screen */}
            <video
              src={loopVideoUrl}
              autoPlay
              muted
              ...
              onEnded={() => {}}
            />
            {/* Foreground layer - properly contained */}
            <video
              src={loopVideoUrl}
              autoPlay
              muted
    ...
    if (id === "olaplex") {
      ...
      return (
        <div className="space-y-8">
          <h4 className="text-xl font-semibold text-white mb-6">DOOH Video Examples</h4>
            ...
            >
              ...
              <div className="px-8 py-16">
                <div className="grid grid-cols-1 gap-12 max-w-7xl mx-auto">
                  {/* Project Details */}
                  <div className="space-y-8">
                    <h3 className="font-playfair text-3xl font-bold mb-6 text-white">{effectiveClient || effectiveTitle}</h3>
                  ...
                  <div className="space-y-8">
                    {id === "syfy-magicians" ? (
                      <RollodexCarousel videos={assets} />
                    ) : (
                      renderVideoSection()
                    )}
            ...
            <div className="px-8 py-16">
              <div className={`${stackedLayout ? "max-w-4xl mx-auto space-y-12" : "grid grid-cols-1 lg:grid-cols-2 gap-12 max-w-7xl mx-auto"}`}>
                ...
                <div className={`space-y-8 ${stackedLayout ? "text-center" : ""}`}>
                  <h3 className={`font-playfair font-bold mb-6 text-white ${stackedLayout ? "text-4xl lg:text-5xl" : "text-3xl"}`}>{effectiveClient || effectiveTitle}</h3>
                  {stackedLayout && (
                  ...
                  <div className="mb-8">
                    {stackedLayout ? (
                      (() => {
                        const creditsCount = [effectiveAgency, effectiveProductionCompany, true].filter(Boolean).length;
